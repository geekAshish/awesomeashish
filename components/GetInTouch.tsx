...
export default function GetInTouch() {
  ...
  return (
    <section className="mx-auto max-w-5xl py-12 md:py-16">
      <h2 className="text-xl font-semibold tracking-tight text-neutral-950 dark:text-white md:text-2xl">Get in touch</h2>
      ...
      >
        <p className="max-w-2xl text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 md:text-base">
          Need crisp edits for ads, reels, or long-form videos? Share your brief and footage, and I will handle the post
          production pipeline.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3 text-sm text-neutral-600 dark:text-neutral-400">
          <span>or connect on socials.</span>
          {SOCIALS.map((s) => (
            <a
              key={s.label}
              href={s.href}
